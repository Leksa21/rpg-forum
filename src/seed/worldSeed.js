...
const seed = async () => {
  ...
  const [
    ...
    { name: 'The Heartlands',    description: 'Golden fields and old roads — the breadbasket of Aldermere.',        mapCoords: { x: 40, y: 22 }, climate: 'temperate' },
    { name: 'The Storm Coast',   description: 'Cliffs and harbors battered by the eastern sea.',                    mapCoords: { x: 94, y: 15 }, climate: 'tropical' },
    { name: 'The Silverwood',    description: 'An ancient forest where the elves keep the old pacts alive.',        mapCoords: { x: 14, y: 28 }, climate: 'temperate' },
    { name: 'The Greymoor',      description: 'Wind-scoured highlands patrolled by the King\'s border garrisons.',  mapCoords: { x: 20, y: 35 }, climate: 'temperate' },
    { name: 'The Ironpeaks',     description: 'The roof of the realm — dwarven halls and air thin as a blade.',     mapCoords: { x: 80, y: 30 }, climate: 'arctic' },
    { name: 'The Mirefen',       description: 'Drowned lowlands of reed, fog, and things best left unnamed.',       mapCoords: { x: 37, y: 85 }, climate: 'tropical' },
    { name: 'The North Shore',   description: 'Cold beaches and fishing fleets under endless gull cries.',          mapCoords: { x: 64, y: 8 }, climate: 'temperate' },
    { name: 'The Drowned Reach', description: 'A sinking isle where a dead empire refuses to stay buried.',         mapCoords: { x: 68, y: 97 }, climate: 'tropical' },
    { name: 'The Barrowlands',   description: 'Grass-swallowed burial mounds of kings no song remembers.',          mapCoords: { x: 14, y: 2 }, climate: 'shadowlands' },
  ]);
  ...
  const [
  ...
  ] = await Location.insertMany([
    {
      ...
      mapCoords: { x: 40, y: 22 }, dangerLevel: 'safe', isStartingLocation: true, population: 18400, faction: 'Crown of Aldermere',
    ...
    },
    {
      ...
      mapCoords: { x: 5, y: 20 }, dangerLevel: 'safe', population: 460, faction: 'Crown of Aldermere',
    ...
    },
    {
      ...
      mapCoords: { x: 94, y: 15 }, dangerLevel: 'medium', population: 9200, faction: 'Harbor League',
    ...
    },
    {
      ...
      mapCoords: { x: 14, y: 28 }, dangerLevel: 'low', population: 3100, faction: 'Silverwood Court',
    ...
    },
    {
      ...
      mapCoords: { x: 36, y: 30 }, dangerLevel: 'medium', population: 140, faction: 'Wardens of the Wood',
    ...
    },
    {
      ...
      mapCoords: { x: 20, y: 35 }, dangerLevel: 'medium', population: 800, faction: 'Crown of Aldermere',
    ...
    },
    {
      ...
      mapCoords: { x: 88, y: 21 }, dangerLevel: 'high', population: 5600, faction: 'Karag Clans',
    ...
    },
    {
      ...
      mapCoords: { x: 74, y: 40 }, dangerLevel: 'high', population: 90, faction: 'Order of the Open Sky',
    ...
    },
    {
      ...
      mapCoords: { x: 37, y: 85 }, dangerLevel: 'high', population: 1100, faction: 'Fenfolk',
    ...
    },
    {
      ...
      mapCoords: { x: 64, y: 8 }, dangerLevel: 'low', population: 380, faction: 'Free Fisherfolk',
    ...
    },
    {
      ...
      mapCoords: { x: 68, y: 97 }, dangerLevel: 'deadly', population: 0, faction: 'None',
    ...
    },
    {
      ...
      mapCoords: { x: 14, y: 2 }, dangerLevel: 'deadly', population: 0, faction: 'None',
