...
const seed = async () => {
  ...
  const [
    ...
    { name: 'The Heartlands',    description: 'Golden fields and old roads — the breadbasket of Aldermere.',        mapCoords: { x: 32, y: 29 }, climate: 'temperate' },
    { name: 'The Storm Coast',   description: 'Cliffs and harbors battered by the eastern sea.',                    mapCoords: { x: 95, y: 19 }, climate: 'tropical' },
    { name: 'The Silverwood',    description: 'An ancient forest where the elves keep the old pacts alive.',        mapCoords: { x: 12, y: 16 }, climate: 'temperate' },
    { name: 'The Greymoor',      description: 'Wind-scoured highlands patrolled by the King\'s border garrisons.',  mapCoords: { x: 16, y: 36 }, climate: 'temperate' },
    { name: 'The Ironpeaks',     description: 'The roof of the realm — dwarven halls and air thin as a blade.',     mapCoords: { x: 82, y: 30 }, climate: 'arctic' },
    { name: 'The Mirefen',       description: 'Drowned lowlands of reed, fog, and things best left unnamed.',       mapCoords: { x: 31, y: 60 }, climate: 'tropical' },
    { name: 'The North Shore',   description: 'Cold beaches and fishing fleets under endless gull cries.',          mapCoords: { x: 63, y: 9 }, climate: 'temperate' },
    { name: 'The Drowned Reach', description: 'A sinking isle where a dead empire refuses to stay buried.',         mapCoords: { x: 71, y: 81 }, climate: 'tropical' },
    { name: 'The Barrowlands',   description: 'Grass-swallowed burial mounds of kings no song remembers.',          mapCoords: { x: 7, y: 50 }, climate: 'shadowlands' },
  ]);
  ...
  const [
  ...
  ] = await Location.insertMany([
    {
      ...
      mapCoords: { x: 32, y: 29 }, dangerLevel: 'safe', isStartingLocation: true, population: 18400, faction: 'Crown of Aldermere',
    ...
    },
    {
      ...
      mapCoords: { x: 11, y: 4 }, dangerLevel: 'safe', population: 460, faction: 'Crown of Aldermere',
    ...
    },
    {
      ...
      mapCoords: { x: 95, y: 19 }, dangerLevel: 'medium', population: 9200, faction: 'Harbor League',
    ...
    },
    {
      ...
      mapCoords: { x: 12, y: 16 }, dangerLevel: 'low', population: 3100, faction: 'Silverwood Court',
    ...
    },
    {
      ...
      mapCoords: { x: 38, y: 28 }, dangerLevel: 'medium', population: 140, faction: 'Wardens of the Wood',
    ...
    },
    {
      ...
      mapCoords: { x: 16, y: 36 }, dangerLevel: 'medium', population: 800, faction: 'Crown of Aldermere',
    ...
    },
    {
      ...
      mapCoords: { x: 87, y: 21 }, dangerLevel: 'high', population: 5600, faction: 'Karag Clans',
    ...
    },
    {
      ...
      mapCoords: { x: 76, y: 40 }, dangerLevel: 'high', population: 90, faction: 'Order of the Open Sky',
    ...
    },
    {
      ...
      mapCoords: { x: 31, y: 60 }, dangerLevel: 'high', population: 1100, faction: 'Fenfolk',
    ...
    },
    {
      ...
      mapCoords: { x: 63, y: 9 }, dangerLevel: 'low', population: 380, faction: 'Free Fisherfolk',
    ...
    },
    {
      ...
      mapCoords: { x: 71, y: 81 }, dangerLevel: 'deadly', population: 0, faction: 'None',
    ...
    },
    {
      ...
      mapCoords: { x: 7, y: 50 }, dangerLevel: 'deadly', population: 0, faction: 'None',
